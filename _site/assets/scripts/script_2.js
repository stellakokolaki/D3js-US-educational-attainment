...
var color = d3.scaleLinear().domain([0, 1/4*5000000, 2/4*5000000, 3/4*5000000, 5000000]).range(["#D9E6A9", "#CFD5B8", "#96B036", "#2F0DC9"]);
...
// color helper style <3 "#D9E6A9", "#CFD5B8", "#96B036", "#2F0DC9", "#4630AA", "#C9571A","#110C29"
        document.forms[0].addEventListener("change", function() {
            treeSumSortType = document.forms[0].elements["treeSum"].value;
            treemap(root
            .sum(function (d) {
                if (treeSumSortType == "number") {
                    color = d3.scaleLinear().domain([0, 1/4*5000000, 2/4*5000000, 3/4*5000000, 5000000]).range(["#D9E6A9", "#CFD5B8", "#96B036", "#2F0DC9"]);
                    return d["Total College"];
                } else if (treeSumSortType == "percent") {
                    color = d3.scaleLinear().domain([0, 1/4*50, 2/4*50, 3/4*50, 50]).range(["#D9E6A9", "#CFD5B8", "#96B036", "#2F0DC9"]);
                    return d["Percent College"];
