...
function donutChart() {
    var width,
        ...
        colour = d3.scaleOrdinal().range(["#D9E6A9", "#CFD5B8", "#96B036", "#2F0DC9", "#4630AA", "#C9571A","#110C29"]),
        // colour scheme "#75b1a9", "#d9b44a", "#4f6457", "#adoco"

        //"#ffdd99", "#75b1a9", "#d9b44a", "#4f6457", "#adoco", "#ffad33", "#ffffe6" 20/1/2019
        //"#D9E6A9", "#CFD5B8", "#96B036", "#2F0DC9", "#4630AA", "#C9571A","#110C29",

        //#0FA3B1= #ffdd99 //"#f7af72", "#FF9B42" ="#ffad33", "#ffffe6"
